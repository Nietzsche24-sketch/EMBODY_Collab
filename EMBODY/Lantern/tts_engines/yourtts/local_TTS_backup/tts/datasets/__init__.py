...
def load_tts_samples(
    ...
    for dataset in datasets:
        ...
        if formatter is None:
            formatter_module = _get_formatter_by_name(formatter_name)
            formatter = formatter_module.load_metadata
            meta_data_train = formatter(dataset, eval_split=False)
        # load train set
...
from TTS.tts.datasets import custom
custom = custom
